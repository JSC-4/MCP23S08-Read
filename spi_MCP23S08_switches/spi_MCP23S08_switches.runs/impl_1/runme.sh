...
HD_PWD='D:/VHDL_Projects/MCP23S08_switches/spi_MCP23S08_switches/spi_MCP23S08_switches.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_MCP23S08_switches_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_MCP23S08_switches_top.tcl -notrace
