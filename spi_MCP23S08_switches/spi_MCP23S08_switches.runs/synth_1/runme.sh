...
HD_PWD='D:/VHDL_Projects/MCP23S08_switches/spi_MCP23S08_switches/spi_MCP23S08_switches.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_MCP23S08_switches_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_MCP23S08_switches_top.tcl
